...
data <- 
  data %>% 
  filter(is.na(exreport) | exreport=="" | exreport=="no") %>% # remove extraordinary reports from the dataset
  select(id = `_id`,
...
::: {.back-contact}
[Vanessa Villalibre]{.back-name}

Reporting Officer

[villalib@unhcr.org](mailto:villalib@unhcr.org)
:::
